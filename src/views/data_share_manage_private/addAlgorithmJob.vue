    ...
    getAlgorList() {
      ...
      getAlgorithmList().then((res) => {
        ...
        for (const v of res.data.data) {
          ...
          this.algorithmList.push(tempData)
        }
    ...
    getDataSourceList() {
      ...
      getPassData().then((res) => {
        ...
        for (const v of res.data.data) {
          var tempData = {
            name: v.dataName,
            owner: v.dataProvider,
            path: '/blockchain/dataset'
          }
          this.dataSourceList.push(tempData)
        }
        this.total = this.dataSourceList.length
      }).catch((error) => {
        console.log(error)
      })
