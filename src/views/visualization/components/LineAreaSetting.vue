    ...
    <el-collapse v-model="setting.activeCol" accordion>
      <el-collapse-item title="全局样式  Style" name="1">
        <el-form ref="styleForm" :model="setting.styleForm" :inline="true" size="mini">
          ...
          <el-form-item label="光滑" size="mini">
            <el-switch v-model="setting.styleForm.smooth"  style="margin-left: 130px;" @change="changeSmooth"> </el-switch>
          </el-form-item>
          <el-form-item label="区域填充颜色" size="mini">
            <el-color-picker v-model="getAreaStyleColor" style="margin-left: 90px;" size="mini"></el-color-picker>
          </el-form-item>
          <el-form-item label="区域填充方式">
            <el-select v-model="getAreaStyleOrign" style="width: 120px;" size="mini" @change="setmyOption">
              <el-option
                v-for="item in setting.areaStyle.origin"
                :key="item.value"
                :label="item.label"
                :value="item.value">
              </el-option>
          ...
          <!--                  <el-checkbox v-model="setting.styleForm.null" size="small" @change="setmyOption">-->
          <!--                  </el-checkbox>-->
          <!--                </el-form-item>-->
          <!--                <el-form-item label="最多加载">-->
          <!--                  <el-input-number v-model="setting.styleForm.showLoading" controls-position="right" :min="1" size="mini" @change="setmyOption"></el-input-number>-->
          <!--                </el-form-item>-->
        </el-form>
      </el-collapse-item>
        ...
        <div style="margin-left: 10px;margin-right: 10px;">
          ...
          <el-collapse v-model="setting.activeTabX" accordion>
            ...
            <el-collapse-item title="网格线" name="5">
              <el-form>
                <el-form-item label="显示" size="mini">
                  <el-switch v-model="myOption.xAxis[0].splitLine.show"  style="margin-left: 30px;" @change="setmyOption"> </el-switch>
                </el-form-item>
                <el-form-item label="颜色" size="mini">
            ...
            <el-collapse-item title="坐标轴指示器" name="3">
              <el-form>
                <el-form-item label="类型" size="mini">
                  <el-select v-model="myOption.tooltip.axisPointer.type"  @change="setmyOption" style="width: 130px;margin-left: 40px;">
    ...
    export default {
            ...
            return {
                ...
                setting: {
                    ...
                    xAxisForm: {
                        ...
                        initDataFormat: 'data1',
                        dataFormat: [
                            {
                                label: '2016/01/01 02:30:00',
                                value: 'time1'
                            }
                        ]
                    },
        ...
        computed: {
            isCatatoryAxis: function () {
                return this.myOption.xAxis[0].type === 'category';
            },
            isTimeAxis: function () {
                return this.myOption.xAxis[0].type === 'time';
            },
            isTimeOrValueAxis: function () {
                return this.myOption.xAxis[0].type === 'time' || this.myOption.xAxis[0].type === 'value';
            },
            isValueAxis: function () {
                return this.myOption.xAxis[0].type === 'value';
            },
            getAreaStyleColor: {
                get() {
                    return this.myOption.series[0].areaStyle.color;
                },
                set(nval) {
                    for (let series of this.myOption.series) {
                        series.areaStyle.color = nval;
                    }
                    this.setmyOption();
                }
            },
            getAreaStyleOrign: {
                get() {
                    return this.myOption.series[0].areaStyle.origin;
                },
                set(nval) {
                    for (let series of this.myOption.series) {
                        series.areaStyle.origin = nval;
                    }
                    this.setmyOption();
                }
            }
        ...
        methods: {
            ...
            changeSmooth: function() {
                for (let data of this.myOption.series){
                    data.smooth = this.setting.styleForm.smooth;
                }
                this.setmyOption();
            },
            changeXAxisBoundaryGap: function() {
                Vue.set(this.myOption.xAxis[0], 'boundaryGap', [this.setting.xAxisForm.boundaryGap+'%', this.setting.xAxisForm.boundaryGap+'%']);
                this.setmyOption();
            },
