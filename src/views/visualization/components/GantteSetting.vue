            ...
            <el-collapse v-model="setting.activeCol" accordion>
              <el-collapse-item title="全局样式  Style" name="1">
                <el-form  :inline="true" >
                  ...
                  <!-- <el-form-item size="mini" label="柱子宽度">
                      <el-input-number v-model="setting.barWidth" style="margin-left: 25px;" controls-position="right" :min="1" :max="50"  @change="changeWidth" ></el-input-number>
                    </el-form-item> -->
  ...
  export default {
    ...
    methods:{
      ...
      changeWidth:function(){
        //alert(this.setting.barWidth)
        //this.myOption.series[0].barWidth=this.setting.barWidth;
        this.myOption.series[1].barWidth=this.setting.barWidth;
        //this.myOption.series[2].barWidth=this.setting.barWidth;
        this.myOption.series[3].barWidth=this.setting.barWidth;
        this.setmyOption();
      }
