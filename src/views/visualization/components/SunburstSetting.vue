      ...
      <el-collapse-item title="全局样式  Style" name="1" size="mini">
        <el-form ref="styleForm" :model="setting.styleForm" :inline="true" size="mini">
          <el-form-item label="字体">
              ...
              <el-select v-model="myOption.textStyle.fontFamily" style="width: 150px;margin-left: 35px;" size="mini" @change="setmyOption">
                <el-option
          ...
          <el-form-item label="外半径" size="mini">
            <el-input-number v-model="setting.styleForm.outerRadius" style="width: 150px;margin-left: 20px;"controls-position="right" :min="0" :max="100" size="mini" @change="changeOuterRadius" @blur="changeOuterRadius"></el-input-number>
          </el-form-item>
          <el-form-item label="内半径" size="mini">
            <el-input-number v-model="setting.styleForm.innerRadius" style="width: 150px;margin-left: 20px;"controls-position="right" :min="0" :max="100" size="mini" @change="changeInnerRadius" @blur="changeInnerRadius"></el-input-number>
          </el-form-item>
<!--          <el-form-item label="高亮方式">-->
<!--            <el-select v-model="myOption.series.highlightPolicy" style="width: 150px;margin-left: 5px;" size="mini" @change="setmyOption">-->
<!--              <el-option-->
<!--                v-for="item in setting.hightlightPolicy"-->
<!--                :key="item.value"-->
<!--                :label="item.label"-->
<!--                :value="item.value">-->
<!--              </el-option>-->
...
<!--          </el-form-item>-->
          ...
          <el-collapse v-model="setting.activeCenterPos">
            <el-collapse-item title="中心位置" name="1" size="mini">
              <el-form-item label="横坐标" size="mini">
                <el-input-number v-model="getCenterX" style="width: 150px;margin-left: 20px;" controls-position="right" :min="0" :max="100" size="mini"></el-input-number>
              </el-form-item>
              <el-form-item label="纵坐标" size="mini">
                <el-input-number v-model="getCenterY" style="width: 150px;margin-left: 20px;" controls-position="right" :min="0" :max="100" size="mini"></el-input-number>
              </el-form-item>
            </el-collapse-item>
          </el-collapse>
        </el-form>
      ...
      <el-collapse-item title="标签 Label" name="3" size="mini">
        <el-form ref="labelForm">
          <el-form-item label="显示" size="mini">
            <el-switch v-model="myOption.series.label.show"  style="margin-left: 115px;" @change="setmyOption"> </el-switch>
          </el-form-item>

          <el-form-item label="角度" size="mini" >
            <el-select v-model="myOption.series.label.rotate" size="mini" style="margin-left: 10px;width: 150px;" @change="setmyOption">
              <el-option
                v-for="item in setting.labelForm.rotateOptions"
                :key="item.value"
                :label="item.label"
                :value="item.value">
              </el-option>
...
<!--            <el-select v-model="myOption.series.label.position" size="mini" @change="setmyOption">-->
<!--              <el-option-->
...
<!--            <el-input-number v-model="myOption.series.label.distance" style="width: 178px;" controls-position="right"  size="mini" @change="setmyOption" @blur="setmyOption"></el-input-number>-->
<!--          </el-form-item>-->
          <el-collapse v-model="setting.activeTabAxisLabelTextStyle" accordion>
            <el-collapse-item title="文本" name="1">
              <el-form ref="labelForm" :model="setting.labelForm" >
                <el-form-item label="字号" size="mini">
                  <el-input-number v-model="myOption.series.label.fontSize" style="margin-left: 10px;width: 150px;" controls-position="right" :min="0" :max="50" size="mini" @change="setmyOption" @blur="setmyOption"></el-input-number>
                </el-form-item>

                <el-form-item label="粗细" size="mini">
                  <el-select v-model="myOption.series.label.fontWeight" style="margin-left: 10px;width: 150px;" size="mini"  @change="setmyOption">
                    <el-option
                      v-for="item in setting.fontWeight"
                      :key="item.value"
                      :label="item.label"
                ...
                <el-form-item label="颜色" size="mini">
                  <el-color-picker v-model="myOption.series.label.color" style="margin-left: 10px;" size="mini" @change="setmyOption"></el-color-picker>
                </el-form-item>
              </el-form>
            </el-collapse-item>
          </el-collapse>
      ...
      <el-collapse-item title="图形样式 Graphic Style" name="4">
        <el-form ref="itemStyleForm" :model="setting.itemStyleForm" size="mini">
          <el-form-item label="颜色" size="mini">
            <el-color-picker v-model="myOption.series.itemStyle.color" style="margin-left: 30px;" size="mini" @change="setmyOption"></el-color-picker>
          </el-form-item>
          <el-form-item label="边框颜色" >
            <el-color-picker v-model="myOption.series.itemStyle.borderColor" style="margin-left: 5px;" size="mini" @change="setmyOption"></el-color-picker>
          </el-form-item>
          <el-form-item label="边框粗细" >
            <el-input-number v-model="myOption.series.itemStyle.borderWidth" style="width: 178px;" controls-position="right" size="mini" @change="setmyOption" @blur="setmyOption" :min="0"></el-input-number>
          </el-form-item>
          <el-form-item label="边框类型" size="mini">
            <el-select v-model="myOption.series.itemStyle.borderType" size="mini"  @change="setmyOption">
              <el-option
  ...
  import Vue from 'vue'
    export default {
        ...
        computed: {
            getCenterX: {
                get() {
                    return this.setting.styleForm.center.x;
                },
                set(nval) {
                    this.setting.styleForm.center.x = nval;
                    Vue.set(this.myOption.series.center, 0, this.setting.styleForm.center.x +'%');
                    this.setmyOption();
                }
            },
            getCenterY: {
                get() {
                    return this.setting.styleForm.center.y;
                },
                set(nval) {
                    this.setting.styleForm.center.y = nval;
                    Vue.set(this.myOption.series.center, 1, this.setting.styleForm.center.y +'%');
                    this.setmyOption();
                }
            }
        },
        ...
        methods: {
            ...
            changeOuterRadius: function(){
                Vue.set(this.myOption.series.radius, 1, this.setting.styleForm.outerRadius+'%');
                this.setmyOption();
            },
            changeInnerRadius: function(){
                Vue.set(this.myOption.series.radius, 0, this.setting.styleForm.innerRadius+'%');
                this.setmyOption();
            },
