...
<!--          </el-form-item>-->
          ...
          <el-form-item label="尺寸" size="mini">
            <el-input-number v-model="setting.radarForm.radius" style="width: 178px;" controls-position="right" :min="0"  @change="changeRadius"></el-input-number>
          </el-form-item>

          <el-form-item label="旋转" size="mini">
            <el-input-number v-model="myOption.radar.startAngle" style="width: 178px;" controls-position="right" :min="0" :max="360" size="mini" @change="changeRadius" ></el-input-number>
          </el-form-item>

          <el-form-item label="形状" size="mini">
            <el-select v-model="myOption.radar.shape"  @change="setmyOption">
              <el-option v-for="item in setting.radarForm.shape" :key="item.value" :label="item.label" :value="item.value">
              </el-option>
            </el-select>
          </el-form-item>
      ...
      <el-collapse-item title="图形样式 Graphic Style" name="3">
        <el-form ref="valueLabel" :model="setting.styleForm.valueLabel"  size="mini">
          <el-form-item label="颜色" size="mini">
            <el-color-picker v-model="myOption.series[0].itemStyle.color"   @change="setmyOption"></el-color-picker>
          </el-form-item>
          <el-collapse v-model="setting.activeTabRadarName" accordion>
          <el-collapse-item title="值标签" name="1">
            <el-form ref="valueLabel" :model="setting.styleForm.valueLabel"  size="mini">
              <el-form-item label="距离" size="mini">
                <el-input-number v-model="myOption.radar.nameGap" style="width: 178px;" controls-position="right" :min="0" :max="50" size="mini" @change="setmyOption" @blur="setmyOption"></el-input-number>
              </el-form-item>
              <el-form-item label="字号" >
                <el-input-number v-model="myOption.radar.name.fontSize" style="width: 178px;" controls-position="right" :min="0" :max="50" size="mini" @change="setmyOption" @blur="setmyOption"></el-input-number>
              </el-form-item>
              <el-form-item label="粗细" size="mini">
                <el-select v-model="myOption.radar.name.fontWeight"  size="mini"  @change="setmyOption">
                  <el-option
                    v-for="item in setting.fontWeight"
                    :key="item.value"
                    :label="item.label"
              ...
              <el-form-item label="颜色" size="mini">
                <el-color-picker v-model="myOption.radar.name.color" style="width: 178px;" size="mini" @change="setmyOption"></el-color-picker>
              </el-form-item>
            </el-form>
          </el-collapse-item>
          <el-collapse-item title="轴线" name="2">
            <el-form ref="valueLabel" :model="setting.styleForm.valueLabel"  size="mini">
              <el-form-item label="显示" size="mini">
                <el-switch v-model="myOption.radar.axisLine.show"  style="margin-left: 140px;" @change="setmyOption"> </el-switch>
              </el-form-item>

              <el-form-item label="宽度" size="mini">
                <el-input-number v-model="myOption.radar.axisLine.lineStyle.width" style="width: 178px;" controls-position="right" :min="0" :max="100" size="mini" @change="setmyOption" @blur="setmyOption"></el-input-number>
              </el-form-item>
              <el-form-item label="类型">
                <el-select v-model="myOption.radar.axisLine.lineStyle.type" size="mini"  @change="setmyOption">
                  <el-option
              ...
              <el-form-item label="颜色" size="mini">
                <el-color-picker v-model="myOption.radar.axisLine.lineStyle.color" style="width: 178px;" size="mini" @change="setmyOption"></el-color-picker>
              </el-form-item>
            </el-form>
          </el-collapse-item>
        </el-collapse>
         <!--  <el-collapse v-model="setting.activeTabItemStyle" accordion>
      ...
      <!--                <el-form-item label="系列值" size="mini">-->
      <!--                  <el-input v-model="setting.dataSeries.series.value" size="mini" @change="setmyOption"></el-input>-->
      <!--                </el-form-item>-->
      <!--                <el-form-item label="系列名" size="mini">-->
      <!--                  <el-input v-model="setting.dataSeries.series.name" size="mini" @change="setmyOption"></el-input>-->
      <!--                </el-form-item>-->
      <!--                <el-form-item label="描边颜色" size="mini">-->
      <!--                  <el-color-picker v-model="setting.dataSeries.series.itemStyle.borderColor" size="mini" @change="setmyOption"></el-color-picker>-->
      <!--                </el-form-item>-->
      <!--                <el-form-item label="描边粗细" size="mini">-->
      <!--                  <div style="margin-top: 20px"></div>-->
      <!--                  <el-slider v-model="setting.dataSeries.series.itemStyle.borderSize" :min='0' :max='100' show-input :step="10" input-size="mini" @change="setmyOption" @input="setmyOption"></el-slider>-->
      <!--                </el-form-item>-->
      <!--                <el-form-item label="填充颜色" size="mini">-->
    ...
    export default {
        ...
        data() {
            return {
                ...
                setting: {
                    ...
                    activeCol: "1",
                    activeTabLegend: "1",
                    activeTabRadarAxisLine: "1",
                    activeTabRadarName: "1",
                    activeTabItemStyle: "1",
        ...
        methods: {
            ...
            changeRadius: function() {
                this.myOption.radar.radius = this.setting.radarForm.radius + '%';
            },
