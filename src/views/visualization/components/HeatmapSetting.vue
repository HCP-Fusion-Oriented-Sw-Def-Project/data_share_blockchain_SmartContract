			...
			<div class="setting">
		        <el-collapse v-model="setting.activeCol" accordion>
		          ...
		          <el-collapse-item title="x轴  XAxis" name="3">
		              	...
		              	<el-select v-model="myOption.yAxis.type" size="mini" @change="setmyOption">
		              		<el-option v-for="item in setting.yAxisType" :key="item.value" :value="item.value" :label="item.label">
		              		</el-option>
		              	</el-select>
		              </div> -->
 	...
 	data(){
	    ...
	    myOption:{
 			...
 			setting:{
	          ...
	          yAxisType:[{value:'value',label:'数值型'},
