      ...
      <el-collapse-item title="全局样式  Style" name="1">
        <el-form ref="styleForm" :model="setting.styleForm" :inline="true" size="mini">
          ...
          <el-form-item label="扇区顺时针排布" size="mini">
            <el-switch v-model="myOption.series[0].clockWise"  style="margin-left: 75px;" @change="setmyOption"> </el-switch>
          </el-form-item>

         <!--  <el-form-item label="数据和为0不显示扇区" size="mini">
            <el-switch v-model="myOption.series[0].stillShowZeroSum"  style="margin-left: 40px;" @change="setmyOption"> </el-switch>
          </el-form-item> -->
          <el-form-item label="选中扇区偏移距离" size="mini">
            <el-input-number v-model="myOption.series[0].selectedOffset" style="margin-left: 40px;width: 178px;" controls-position="right" :min="0"  @change="setmyOption"></el-input-number>
          </el-form-item>

          <el-form-item label="最小扇区角度" size="mini">
            <el-input-number v-model="myOption.series[0].minAngle" style="margin-left: 40px;width: 178px;" controls-position="right" :min="0"  @change="setmyOption"></el-input-number>
          </el-form-item>
<!--          <el-form-item label="最小标签显示角度" size="mini">-->
<!--            <el-input-number v-model="myOption.series[0].minShowLabelAngle" style="margin-left: 40px;width: 178px;" controls-position="right" :min="0"  @change="setmyOption"></el-input-number>-->
<!--          </el-form-item>-->
          <el-form-item label="选择模式">
            <el-select v-model="myOption.series[0].selectedMode" style="width: 150px;"  @change="setmyOption">
          ...
          <el-form-item label="起始角度" size="mini">
            <el-input-number v-model="myOption.series[0].startAngle" style="width: 150px;" controls-position="right" :min="0"  @change="setmyOption"></el-input-number>
          </el-form-item>
      ...
      <el-collapse-item title="标签 Label" name="3">
        <el-form>
          <el-form-item label="显示" size="mini">
            <el-switch v-model="myOption.series[0].label.show"  style="margin-left: 135px;" @change="setmyOption"> </el-switch>
          </el-form-item>
...
<!--                    <el-switch v-model="setting.catatoryForm.number.realNumber"  style="margin-left: 105px;" @change="setmyOption"> </el-switch>-->
<!--                  </el-form-item>-->
<!--                </el-form>-->
<!--              </el-collapse-item>-->
<!--            </el-collapse>-->
