    ...
    <el-collapse v-model="setting.activeCol" accordion>
      <el-collapse-item title="全局样式  Style" name="1">
        <el-form ref="styleForm" :model="setting.styleForm" :inline="true" size="mini">
          ...
          <el-form-item>
            ...
            <div class="style_input">
              <div><span>顶部</span>
                <el-input-number v-model="myOption.series[0].top" controls-position="right" :min="0" size="mini" @change="setmyOption" ></el-input-number>
              </div>
              <div><span>底部</span>
                <el-input-number v-model="myOption.series[0].bottom" controls-position="right"  size="mini" :min="0" @change="setmyOption" ></el-input-number>
              </div>
              <div><span>左侧</span>
                <el-input-number v-model="myOption.series[0].left" controls-position="right"  size="mini" :min="0" @change="setmyOption" ></el-input-number>
               </div>
               <div><span>右侧</span>
                <el-input-number v-model="myOption.series[0].right" controls-position="right"  size="mini" :min="0" @change="setmyOption" ></el-input-number>
              </div>
             </div>
          </el-form-item>
      ...
      <el-collapse-item title="标签 Label" name="3" size="mini">
        <el-form>
          <el-form-item label="位置" size="mini">
            <el-select v-model="myOption.series[0].label.position"  @change="setmyOption">
              <el-option v-for="item in setting.labelForm.positions" :key="item.value" :label="item.label" :value="item.value">
              </el-option>
            </el-select>
          </el-form-item>
        </el-form>
        ...
        <el-collapse v-model="setting.activeTabLabel" accordion>
          <el-collapse-item title="文本" name="1" size="mini">
            <el-form >
              <el-form-item label="字体" size="mini">
                <el-select v-model="myOption.series[0].label.fontFamily"  @change="setmyOption">
              ...
              <!-- <el-form-item label="水平对齐" size="mini">
                <el-select v-model="myOption.series[0].label.align"  @change="setmyOption">
                  <el-option v-for="item in setting.horizontalAlign" :key="item.value" :label="item.label" :value="item.value">
                  </el-option>
                </el-select>
              </el-form-item>
              <el-form-item label="垂直对齐" size="mini">
                <el-select v-model="myOption.series[0].label.verticalAlign"  @change="setmyOption">
                  <el-option v-for="item in setting.verticalAlign" :key="item.value" :label="item.label" :value="item.value">
                  </el-option>
                </el-select>
              </el-form-item> -->

              <el-form-item label="颜色" size="mini">
                <el-color-picker v-model="myOption.series[0].label.color"   style="margin-left: 25px;" @change="setmyOption"></el-color-picker>
              </el-form-item>

            </el-form>
          </el-collapse-item>
          <el-collapse-item title="视觉引导线 Vision Guide Line" name="4" size="mini">
            <el-form>
              <el-form-item label="长度" size="mini">
                <el-input-number v-model="myOption.series[0].labelLine.length" style="width: 178px;" controls-position="right" :min="0"  @change="setmyOption"></el-input-number>
              </el-form-item>
              <el-form>
                <el-form-item label="颜色" size="mini">
                  <el-color-picker v-model="myOption.series[0].labelLine.lineStyle.color"   @change="setmyOption"></el-color-picker>
                </el-form-item>
                <el-form-item label="宽度" size="mini">
                  <el-input-number v-model="myOption.series[0].labelLine.lineStyle.width" style="width: 178px;" controls-position="right" :min="0"  @change="setmyOption"></el-input-number>
                </el-form-item>
                <el-form-item label="类型" size="mini">
                  <el-select v-model="myOption.series[0].labelLine.lineStyle.type"  @change="setmyOption">
     ...
     <!--  <el-collapse-item title="图形样式 Graphic Style" name="5" size="mini">
        <el-form>
          <el-form-item label="颜色" size="mini">
