      ...
      <el-collapse-item title="点的样式 Dot Style" name="5">
        <el-form size="mini">
          <el-form-item label="圆点大小" >
            <el-input-number v-model="setting.series.symbolSize" style="margin-left: 10px;width: 150px;"  controls-position="right" :min="0" :max="200" ></el-input-number>
          </el-form-item>
          <el-form-item label="边框宽度" size="mini">
            <el-input-number v-model="setting.series.borderWidth" style="margin-left: 10px;width: 150px;" controls-position="right" :min="0" :max="10"  ></el-input-number>
          </el-form-item>
          ...
          <el-form-item label="边框颜色" >
            <el-color-picker v-model="setting.series.borderColor" style="margin-left: 10px;"  ></el-color-picker>
          </el-form-item>
        </el-form>
      </el-collapse-item>
