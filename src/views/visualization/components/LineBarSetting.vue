			...
			<div class="setting">
				<el-collapse v-model="setting.activeCol" accordion>
								...
								<el-collapse-item title="布局" name="3">
									<el-form  :inline="true" size="mini">
										<el-form-item label="标题间距" size="mini">
											<el-input-number v-model="myOption.title.itemGap" style="width: 178px;" controls-position="right" :min="0" :max="50" @change="setmyOption"></el-input-number>
										</el-form-item>
										<el-form-item label="水平对齐" size="mini">
											<el-select v-model="myOption.title.textAlign"  @change="setmyOption">
												<el-option
										...
										<!-- <el-form-item label="标题位置" size="mini">
											<el-select v-model="setting.titleForm.position" size="mini" @change="setTitlePosition">
												<el-option
												v-for="item in setting.titleForm.positionmyOptions"
												:key="item.value"
												:label="item.label"
												:value="item.value">
												</el-option>
                  ...
                  <el-switch v-model="myOption.xAxis.splitLine.show"  style="margin-left: 30px;" @change="setmyOption"> </el-switch>
					...
					<el-collapse-item title="y轴  YAxis[0]" name="4">
						<div style="margin-left: 10px;margin-right: 10px;">
							<el-collapse v-model="setting.activeTabY" accordion>
								...
								<el-collapse-item title="网格线" name="5">
									<el-form >
										<el-form-item label="显示" size="mini">
                  <el-switch v-model="myOption.yAxis[0].splitLine.show"  style="margin-left: 30px;" @change="setmyOption"> </el-switch>
                </el-form-item>
										<el-form-item label="颜色" size="mini">
					...
					<el-collapse-item title="y2轴  Y2Axis" name="5">
						<div style="margin-left: 10px;margin-right: 10px;">
							<el-collapse v-model="setting.activeTabY2" accordion>
								<el-collapse-item title="文本" name="1">
									<el-form size="mini">
										<el-form-item label="字号" >
											<el-input-number v-model="myOption.yAxis[1].axisLabel.textStyle.fontSize" style="margin-left: 30px;width: 178px;"  controls-position="right" :min="0" :max="50" @change="setmyOption"></el-input-number>
										</el-form-item>
										<el-form-item label="粗细" >
											<el-select v-model="myOption.yAxis[1].axisLabel.textStyle.fontWeight" style="margin-left: 30px;width: 178px;"  @change="setmyOption">
												<el-option v-for="item in setting.fontWeight" :key="item.value" :label="item.label" :value="item.value">
												</el-option>
											</el-select>
										</el-form-item>
										<el-form-item label="颜色" >
											<el-color-picker v-model="myOption.yAxis[1].axisLabel.textStyle.color" style="margin-left: 30px;width: 178px;"   @change="setmyOption"></el-color-picker>
										</el-form-item>
									</el-form>
								</el-collapse-item>
								<el-collapse-item title="轴标签" name="2">
									<el-form size="mini">
										<el-form-item label="角度" >
											<el-input-number v-model="myOption.yAxis[1].axisLabel.rotate" style="margin-left: 30px;width: 178px;"  controls-position="right" @change="setmyOption"  :min="-90" :max='90'></el-input-number>
										</el-form-item>
										<!-- 距离是距离轴的距离 -->
										<el-form-item label="距离" >
											<el-input-number v-model="myOption.yAxis[1].axisLabel.margin" style="margin-left: 30px;width: 178px;" controls-position="right" @change="setmyOption"  :min="0" :max='200'></el-input-number>
										</el-form-item>
									</el-form>
								</el-collapse-item>
								<el-collapse-item title="轴单位" name="3">
									<el-form >
										<el-form-item label="单位" size="mini">
											<el-input v-model="myOption.yAxis[1].name" placeholder="请输入单位" @change="setmyOption" style="width: 178px;margin-left: 30px;"></el-input>
										</el-form-item>
									</el-form>
								</el-collapse-item>
								<el-collapse-item title="轴线" name="4">
									<el-form >
										<el-form-item label="颜色" size="mini">
											<el-color-picker v-model="myOption.yAxis[1].axisLine.lineStyle.color" style="margin-left: 30px;" @change="setmyOption"></el-color-picker>
										</el-form-item>
									</el-form>
								</el-collapse-item>
								<el-collapse-item title="网格线" name="5">
									<el-form >
										<el-form-item label="显示" size="mini">
                  <el-switch v-model="myOption.yAxis[1].splitLine.show"  style="margin-left: 30px;" @change="setmyOption"> </el-switch>
                </el-form-item>
										<el-form-item label="颜色" size="mini">
											<el-color-picker v-model="myOption.yAxis[1].splitLine.lineStyle.color"  style="margin-left: 30px;" show-alpha  @change="setmyOption"></el-color-picker>
										</el-form-item>
									</el-form>
								</el-collapse-item>
							</el-collapse>
					...
					<el-collapse-item title="数据系列  Data series" name="8">
						<div style="margin-left: 10px;margin-right: 10px;">
							<el-collapse v-model="setting.activeDataSource" accordion>
								<el-collapse-item title="柱子" name="1">
									<el-form >

										<el-form-item label="柱子颜色" size="mini">
											<el-color-picker v-model="setting.OPdatasource.pillar.color"  ></el-color-picker>
										</el-form-item>
										<el-form-item label="柱子宽度" size="mini">
											<el-input-number v-model="setting.OPdatasource.pillar.width" controls-position="right"> </el-input-number>
										</el-form-item>

									</el-form>
								</el-collapse-item>

								<el-collapse-item title="折线" name="2">
									<el-form >

										<el-form-item label="折线类型" size="mini">
											<el-select v-model="setting.OPdatasource.brokenline.linetype" >
												<el-option v-for="item in setting.LineType" :key="item.value" :label="item.label" :value="item.value">
												</el-option>
											</el-select>
										</el-form-item>
										<el-form-item label="折线粗细" size="mini">
											<el-input-number v-model="setting.OPdatasource.brokenline.lineweight" controls-position="right" :min="1"   ></el-input-number>
										</el-form-item>
										<el-form-item label="近似曲线" size="mini">
											<el-switch v-model="setting.OPdatasource.brokenline.curved"></el-switch>
					...
					<el-collapse-item title="动画  Animation" name="9">
						<div style="margin-left: 10px;margin-right: 10px;">
							<el-form >
...
export default {
	...
	data(){
		return{
			...
			setting:{
				...
				labellocation:[{value:'顶部',label:'顶部'},
				{value:'中间',label:'中间'},
				{value:'底部',label:'底部'}],
	...
	computed:{
		getpillarColor(){
			return this.setting.OPdatasource.pillar.color
		},
		getpillarWidth(){
			return this.setting.OPdatasource.pillar.width
		},
		getbroType(){
			return this.setting.OPdatasource.brokenline.linetype
		},
		getborWeight(){
			return this.setting.OPdatasource.brokenline.lineweight
		},
		getborCurved(){
			return this.setting.OPdatasource.brokenline.curved
		}
	},
	watch: {
            option: {
            ...
            getpillarColor(nval,oval){
            	for(let i=0;i<this.myOption.series.length;i++)
            	{
            		if(this.myOption.series[i].type=='bar')
            			this.myOption.series[i].itemStyle.color=nval;
            	}
            	this.setmyOption()
            },
            getpillarWidth(nval,oval){
            	for(let i=0;i<this.myOption.series.length;i++)
            	{
            		if(this.myOption.series[i].type=='bar')
            			this.myOption.series[i].barWidth=nval;
            	}
            	this.setmyOption()
            },
            getbroType(nval,oval){
            	for(let i=0;i<this.myOption.series.length;i++)
            	{
            		if(this.myOption.series[i].type=='line')
            			this.myOption.series[i].lineStyle.type=nval;
            	}
            	this.setmyOption()
            },
            getborWeight(nval,oval){
            	for(let i=0;i<this.myOption.series.length;i++)
            	{
            		if(this.myOption.series[i].type=='line')
            			this.myOption.series[i].lineStyle.width=nval;
            	}
            	this.setmyOption()
            },
            getborCurved(nval,oval){
            	for(let i=0;i<this.myOption.series.length;i++)
            	{
            		if(this.myOption.series[i].type=='line')
            			this.myOption.series[i].smooth=nval;
            	}
            	this.setmyOption()
            }
        },
