...
export default {
    ...
    'parentHeight':'initChart',
      option: {
          handler(nval, oval) {
              ...
              this.myOption = nval;
              if (this.myOption.series.data.length === 0){
                  this.updateData();
              }
  ...
  methods: {
    ...
    dataSunburst:function(){
        ...
        // this.colToRow();
        // let temXAxis=JSON.parse(JSON.stringify(this.xAxis));
        // var ylist = [];
        // for(var i=0;i<this.xAxis.length;i++){
        //     var indicator=[];
        //     for(var j=0;j<this.xAxis[i].list.length;j++){
        ...
        //         }
        //     }
        //     temXAxis.list=indicator
        // }
        //
        // for(let i=0; i<this.xAxis[0].length; i++){
        //
        // }
        //
        // for(let i=0;i<this.xAxis[0].list.length;i++){
      ...
      deleteNullLeaf(children) {
          ...
          for (let i=0; i<children.length; ++i) {
              ...
              if (child.name === null) {
                  ...
                  this.deleteNullLeaf(child.children)
              }
          }
      },
    updateData: function(){
        ...
        this.dataSunburst();
        this.myOption.series.data = this.yAxis[0].list;
