        ...
        <el-form ref="styleForm" :model="setting.styleForm" :inline="true" size="mini">
          ...
          <el-form-item>
            ...
            <div class="style_input">
                  ...
                  <div><span>顶部</span>
               <el-input-number v-model="myOption.series[0].top" controls-position="right"  size="mini" @change="setmyOption" @blur="setmyOption"></el-input-number>
             </div>
                  <div><span>底部</span>
              <el-input-number v-model="myOption.series[0].bottom" controls-position="right"  size="mini" @change="setmyOption" @blur="setmyOption"></el-input-number>
              </div>
                  <div><span>左侧</span>
              <el-input-number v-model="myOption.series[0].left" controls-position="right"  size="mini" @change="setmyOption" @blur="setmyOption"></el-input-number>
              </div>
                  <div><span>右侧</span>
              <el-input-number v-model="myOption.series[0].right" controls-position="right"  size="mini" @change="setmyOption" @blur="setmyOption"></el-input-number>
            </div>
            </div>
          </el-form-item>
          <el-form-item label="可拖拽" size="mini">
            <el-switch v-model="myOption.series[0].draggable"  style="margin-left: 120px;" @change="setmyOption"> </el-switch>
          </el-form-item>
<!--          <el-form-item label="节点对齐">-->
<!--            <el-select v-model="myOption.series[0].nodeAlign" style="width: 150px;" size="mini" @change="setmyOption">-->
<!--              <el-option-->
<!--                v-for="item in setting.styleForm.nodeAlignOptions"-->
<!--                :key="item.value"-->
<!--                :label="item.label"-->
<!--                :value="item.value">-->
<!--              </el-option>-->
...
<!--          </el-form-item>-->
          ...
          <el-form-item label="节点方向">
            <el-select v-model="myOption.series[0].orient" size="mini" style="width: 150px;" @change="setmyOption">
              <el-option
                v-for="item in setting.styleForm.orientOptions"
                :key="item.value"
                :label="item.label"
                :value="item.value">
              </el-option>
          ...
          <el-form-item label="节点宽度" size="mini">
            <el-input-number v-model="myOption.series[0].nodeWidth" style="width: 150px;" controls-position="right" :min="0" :max="50" size="mini" @change="setmyOption" @blur="setmyOption"></el-input-number>
          </el-form-item>
          <el-form-item label="优化位置" size="mini">
            <el-input-number v-model="myOption.series[0].layoutIterations" style="width: 150px;" controls-position="right" :min="32"   size="mini" @change="setmyOption" @blur="setmyOption"></el-input-number>
          </el-form-item>


          <el-form-item label="节点间隔" size="mini">
            <el-input-number v-model="myOption.series[0].nodeGap" style="width: 150px;" controls-position="right" :min="0"  size="mini" @change="setmyOption" @blur="setmyOption"></el-input-number>
          </el-form-item>
      ...
      <el-collapse-item title="标签 Label" name="3" >
        <el-form>
          <el-form-item label="显示" size="mini">
            <el-switch v-model="myOption.series[0].label.show"  style="margin-left: 140px;" @change="setmyOption"> </el-switch>
          </el-form-item>
          <el-form-item label="颜色" size="mini">
            <el-color-picker v-model="myOption.series[0].label.color"   style="margin-left: 150px;" @change="setmyOption"></el-color-picker>
          </el-form-item>
          <el-form-item label="角度" size="mini">
            <el-input-number v-model="myOption.series[0].label.rotate" style="width: 178px;" controls-position="right" :min="-90" :max="90" size="mini" @change="setmyOption" @blur="setmyOption"></el-input-number>
          </el-form-item>
          <el-form-item label="位置">
            <el-select v-model="myOption.series[0].label.position" size="mini" @change="setmyOption">
              <el-option
                v-for="item in setting.labelForm.positionOptions"
                :key="item.value"
                :label="item.label"
                :value="item.value">
              </el-option>
          ...
          <el-form-item label="距离" size="mini">
            <el-input-number v-model="myOption.series[0].label.distance" style="width: 178px;" controls-position="right" :min="-90" :max="90" size="mini" @change="setmyOption" @blur="setmyOption"></el-input-number>
          </el-form-item>


          <el-collapse v-model="setting.activeTabLabelOffset">
            <el-collapse-item title="位移" name="1">
              <el-form>
                <el-form-item label="横向偏移" size="mini">
                  <el-input-number v-model="setting.labelForm.offset.x" style="width: 178px;" controls-position="right"  size="mini" @change="changeLabelOffsetX" @blur="changeLabelOffsetX"></el-input-number>
                </el-form-item>
                <el-form-item label="纵向偏移" size="mini">
                  <el-input-number v-model="setting.labelForm.offset.y" style="width: 178px;" controls-position="right"  size="mini" @change="changeLabelOffsetY" @blur="changeLabelOffsetY"></el-input-number>
                </el-form-item>
              </el-form>
            </el-collapse-item>
          </el-collapse>
          <el-collapse v-model="setting.activeTabAxisLabelTextStyle" accordion>
            <el-collapse-item title="文本" name="1">
              <el-form ref="labelForm" :model="setting.labelForm" >
                <el-form-item label="字号" size="mini">
                  <el-input-number v-model="myOption.series[0].label.fontSize" style="width: 178px;" controls-position="right" :min="0" :max="50" size="mini" @change="setmyOption" @blur="setmyOption"></el-input-number>
                </el-form-item>
                <el-form-item label="颜色" size="mini">
                  <el-color-picker v-model="myOption.series[0].label.color" style="width: 178px;" size="mini" @change="setmyOption"></el-color-picker>
                </el-form-item>
                <el-form-item label="粗细" size="mini">
                  <el-select v-model="myOption.series[0].label.fontWeight" size="mini"  @change="setmyOption">
                    <el-option
                      v-for="item in setting.fontWeight"
                      :key="item.value"
                      :label="item.label"
      ...
      <el-collapse-item title="图形样式 Graphic Style" name="4">
        <el-form ref="itemStyleForm" :model="setting.itemStyleForm" size="mini">
          <el-form-item label="颜色" size="mini">
            <el-color-picker v-model="myOption.series[0].itemStyle.color"   style="margin-left: 50px;" @change="setmyOption"></el-color-picker>
          </el-form-item>
          ...
          <el-form-item label="边框粗细" >
            <el-input-number v-model="myOption.series[0].itemStyle.borderWidth" style="width: 178px;" controls-position="right" size="mini" @change="setmyOption" @blur="setmyOption" :min="0"></el-input-number>
          </el-form-item>
          <el-form-item label="边框类型" size="mini">
      ...
      <el-collapse-item title="连线样式 Links Style" name="5">
        <el-form ref="linksStyleForm" :model="setting.linksStyleForm" size="mini">
          <el-form-item label="透明度" size="mini">
            <el-input-number v-model="myOption.series[0].lineStyle.opacity" style="width: 178px;" controls-position="right" :min="0" :max="1" :step=0.1 size="mini" @change="setmyOption" @blur="setmyOption"></el-input-number>
          </el-form-item>
          <el-form-item label="曲度" size="mini">
            <el-input-number v-model="myOption.series[0].lineStyle.curveness" style="width: 178px;     margin-left: 15px;" controls-position="right" :min="0" :max="1" :step=0.1 size="mini" @change="setmyOption" @blur="setmyOption"></el-input-number>
          </el-form-item>
        </el-form>
      </el-collapse-item>
...
<script>
  import Vue from 'vue'
    export default {
        ...
        mounted() {
            this.setmyOption(); //将myOption传递给父组件
        },
        methods: {
            ...
            changeLabelOffsetX: function() {
                Vue.set(this.myOption.series[0].label.offset, 0, this.setting.labelForm.offset.x);
                this.setmyOption();
            },
            changeLabelOffsetY: function() {
                Vue.set(this.myOption.series[0].label.offset, 1, this.setting.labelForm.offset.y);
                this.setmyOption();
            },
